...
ggplot(aes(x = Year, y = gpp )) + geom_line(alpha = 0.5) + geom_point_interactive(aes(tooltip = gpp), color = '#00868B') +
...
x <- list(
  title = "")
y <- list(
  title = "global plastic production in million tonnes")
...
ggplot(aes(x = Year, y = cgpp )) + geom_area(fill = '#00868B') + geom_point_interactive(aes(tooltip = cgpp), color = '#00868B') +
  scale_x_continuous(limits = c(1950, 2015), breaks = c(1950, 1960, 1970, 1980, 1990, 2000, 2010, 2015), expand = c(0.02,0.02)) +
